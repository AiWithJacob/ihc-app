# 📚 Dokumentacja IHC MVP

Ten folder zawiera kompletną dokumentację projektu.
...
1. Przeczytaj **SUPABASE-SETUP.md** - skonfiguruj bazę danych
2. Przeczytaj **AUDIT-LOG-SETUP.md** - skonfiguruj audit log
3. Przeczytaj **BACKUP-SETUP-GUIDE.md** - skonfiguruj automatyczny backup
4. Przeczytaj **DEPLOY-VERCEL.md** - wdróż aplikację

## 📞 Wsparcie

Wszystkie dokumenty zawierają szczegółowe instrukcje krok po kroku. Jeśli masz pytania, sprawdź odpowiednią dokumentację.
